...
#define NPA asize(pa)
    ...
    char            fnout[STRLEN], comment[STRLEN], defineName[STRLEN], *molname;
    rvec            *xtop;
    t_atoms        *atoms;
    time_t          timeNow;
...
#define NFILE asize(fnm)
    ...
    snew(top,1);
    read_tps_conf(in_file, top, &ePBC, &xtop, NULL, box, 0);
     ...
     */
    read_tpx_state(in_file, &dummyir, &dummystate, &mtop);
